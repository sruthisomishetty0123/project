...
d3.json("../jsonfiles/p2b.json",function(error, data) {
 ...
 svg.selectAll('rect')
   ...
   .style("fill", function(d,i) { return 'rgb( ' + ((i * 30) + 100) + ',20,20)'});
       ...
       svg.selectAll('text')
           ...
           .text(function(d){
               return d["GDP Billions (USD) 2013"];
           })
           .attr({
               "x": function(d){ return xScale(d["Country Name"]) +  xScale.rangeBand()/2; },
               "y": function(d){ return yScale(d["GDP Billions (USD) 2013"])+ 12; },
   ...
   svg.append("g")
       ...
       svg.append("text")
        ...
        .text("a bar chart of GDP by country of 2013");
});})();